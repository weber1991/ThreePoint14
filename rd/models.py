...
class BUserListType(models.Model):
    ...
    type = models.ForeignKey("self", null=True, blank=True, verbose_name="父类名称")
...
class BMessageType(models.Model):
    ...
    type = models.ForeignKey('self', null=True, blank=True, verbose_name='父级类型')
...
class BMessage(models.Model):
    user = models.ForeignKey(BUser, verbose_name='留言人',null=True, blank=True)
    ...
    type = models.ForeignKey(BMessageType, verbose_name="留言类型")
